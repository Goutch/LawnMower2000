...
{
    [AddComponentMenu("Event/Standalone New Input Module")]
    /// <summary>
    ...
    public class NewInputModule : PointerInputModule
    {
        ...
        [SerializeField]
        private string m_HorizontalAxis = "MoveHorizontal";

        /// <summary>
        /// Name of the vertical axis for movement (if axis events are used).
        /// </summary>
        [SerializeField]
        private string m_VerticalAxis = "MoveVertical";

        [SerializeField]
        private string m_AlternateHorizontalAxis = "MoveHorizontalCross";

        [SerializeField] 
        private string m_AlternateVerticalAxis = "MoveVerticalCross";
        
        /// <summary>
        /// Name of the submit button.
        /// </summary>
        [SerializeField]
        private string m_SubmitButton = "Continue";

        /// <summary>
        /// Name of the submit button.
        /// </summary>
        [SerializeField]
        private string m_CancelButton = "BackMenu";
        ...
        public string alternateHorizontalAxis
        {
            get => m_AlternateHorizontalAxis;
            set => m_AlternateHorizontalAxis = value;
        }

        public string alternateVerticalAxis
        {
            get => m_AlternateVerticalAxis;
            set => m_AlternateVerticalAxis = value;
        }
        ...
        public override bool ShouldActivateModule()
        {
            ...
            shouldActivate |= !Mathf.Approximately(input.GetAxisRaw(m_AlternateHorizontalAxis), 0.0f);
            shouldActivate |= !Mathf.Approximately(input.GetAxisRaw(m_AlternateVerticalAxis), 0.0f);
        ...
        private Vector2 GetRawMoveVector()
        {
            ...
            Vector2 moveFirstSource = Vector2.zero;
            Vector2 moveSecondSource = Vector2.zero;
            
            moveFirstSource.x = input.GetAxisRaw(m_HorizontalAxis);
            moveFirstSource.y = input.GetAxisRaw(m_VerticalAxis);
            
            moveSecondSource.x = input.GetAxisRaw(m_AlternateHorizontalAxis);
            moveSecondSource.y = input.GetAxisRaw(m_AlternateVerticalAxis);
            
            /*if (input.GetAxisRaw(m_HorizontalAxis) == 0 && input.GetAxisRaw(m_AlternateHorizontalAxis) ==0 )
            {
                move.x = input.GetAxisRaw(m_HorizontalAxis);
            }
            else if (input.GetAxisRaw(m_HorizontalAxis) != 0)
            {
                move.x = input.GetAxisRaw(m_HorizontalAxis);
            }
            else
            {
                move.x = input.GetAxisRaw(m_AlternateHorizontalAxis);
            }
            
            if (input.GetAxisRaw(m_VerticalAxis) == 0 && input.GetAxisRaw(m_AlternateVerticalAxis) ==0 )
            {
            ...
            {
                move.y = input.GetAxisRaw(m_AlternateVerticalAxis);
            }
*/
            if (moveFirstSource.x !=0)
            {
                if (moveFirstSource.x < 0)
                    move.x = -1f;
                if (moveFirstSource.x > 0)
